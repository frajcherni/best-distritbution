...
export default function Footer() {
  return (
    ...
    <div className="">
      ...
      <img className='w-32 h-32 rounded-full' src={`../../${import.meta.env.BASE_URL}/images/result.png`} alt="Logo" />
    </div>



                <p className="text-center text-black-200">Trusted in more than 100 countries & 5 million customers.
                        ...
                        <svg className="w-[1.25rem] h-[1.125rem]" viewBox="0 0 15 15" fill="none"
                            ...
                            <defs>
                                <linearGradient id="paint0_linear_9147_17049" x1="14.6041" y1="1.67072"
                                    ...
                                    <stop offset="0.993738" stop-color="#006A4E" />
                                </linearGradient>
                            </defs>
                        </svg>
            ...
            <div className="block text-center xl:text-left xl:py-16 col-span-full min-[500px]:col-span-6 md:col-span-4 xl:col-span-3 xl:pl-5">
                ...
                <ul className="text-gray-900 transition-all duration-500 grid gap-6">
                    ...
                    <li>1230 Maecenas Street Donec Road</li>
                </ul>
            </div>
            ...
            <div className="block xl:py-16 col-span-full md:col-span-4 xl:col-span-3">
                ...
                <div className="grid gap-7 ">
                    ...
                    <button type="submit"
                        className="flex gap-2 justify-center items-center py-3.5 px-7 rounded-full text-white bg-green-900 shadow-md w-fit transition-all duration-500 mx-auto xl:mx-0 hover:bg-green-700">Subscribe<svg
